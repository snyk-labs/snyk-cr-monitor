...
var getDockerRepos = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get("https://" + artifactoryServername + ".jfrog.io/artifactory/api/repositories?packageType=docker", {
                    headers: {
...
var getImageRepos = function (repoKey) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get("https://snyk.jfrog.io/artifactory/api/docker/" + repoKey + "/v2/_catalog", {
                    headers: {
                        Accept: "application/json",
                        "X-JFrog-Art-Api": artifactoryKey
                    }
    ...
    if (i < jobs.length) {
        ...
        (function () {
            setTimeout(function () {
                ...
                var execDockerLogin = "docker login " + artifactoryServername + "-" + jobs[i].dockerRepo + ".jfrog.io -u " + artifactoryUser + " -p " + artifactoryKey + " 2>/dev/null; ";
                var execSnykMonitor = "snyk monitor --docker " + artifactoryServername + "-" + jobs[i].dockerRepo + ".jfrog.io/" + jobs[i].imageRepo + "; ";
                var execDockerRemove = "docker image rm " + artifactoryServername + "-" + jobs[i].dockerRepo + ".jfrog.io/" + jobs[i].imageRepo;
