    ...
    if (i < jobs.length) {
        ...
        (function () {
            setTimeout(function () {
                ...
                var execDockerLogin = "docker login " + _artifactoryCliHost + " -u " + artifactoryUser + " -p " + artifactoryKey + " && ";
                var execSnykMonitor = "snyk monitor --docker " + _artifactoryCliHost + "/" + jobs[i].imageRepo + ":" + jobs[i].imageTag + " --project-name=\"" + projectName + "\" && ";
                var execDockerRemove = "docker image rm " + _artifactoryCliHost + "/" + jobs[i].imageRepo + ":" + jobs[i].imageTag + " --force";
